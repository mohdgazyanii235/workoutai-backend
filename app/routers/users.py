...
def get_public_profile(
    ...
    nudge_count_weekly = crud.get_weekly_interaction_count(db, current_user.id, 'nudge')
    spot_count_weekly = crud.get_weekly_interaction_count(db, current_user.id, 'spot')
    ...
    return schemas.PublicUser(
        ...
        friend_count=crud.get_friend_count(db, db_user.id),
